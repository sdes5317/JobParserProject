...
namespace JobParser
{
    public class RemoteRepository
    {
        ...
        public async Task<HttpResponseMessage> UpdateNewJobsAsync(IEnumerable<JobDto> jobDtos)
        {
        ...
        public async Task<HttpResponseMessage> PublishYesterdayJobToUserAsync()
        {
